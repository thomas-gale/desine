  ...
  return (
    <div className="m-8">
      ...
      <ol className="list-decimal list-inside">
        ...
        <li>
          Take the the unique and deterministic{" "}
          <a href="ipns://docs.ipfs.tech/concepts/content-addressing/">
            content identifier
          </a>{" "}
          and paste into the NFT minting transaction inputs. The minting
      ...
      <p>
        ...
        upload in unencrypted form for others to use. We feel the true solution
        ...
        payments or has been correctly compensated and willing sold the design
      ...
      <p>
        ...
        some form of centralization (we we don't want ideally). OpenSea does
